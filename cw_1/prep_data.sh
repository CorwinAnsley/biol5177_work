...
do
    raw_file=$fqpath/${sample}.c2.fq  # path to the raw fast file 
    link_name=/export/biostuds/2266643a/BIOL5177_rnaseq/biol5177_work/cw_1/data/${sample}.c2.fq     # link-name to appear in your directory 

    ln -s $raw_file $link_name             # instruction to make a soft link 
    test_file=/export/biostuds/2266643a/BIOL5177_rnaseq/biol5177_work/cw_1/data/${sample}.c2.25K.fq       # test fast file containing 25K reads 
