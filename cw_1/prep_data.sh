...
do
    ...
    link_name=/export/biostuds/2266643a/BIOL5177_rnaseq/biol5177_work/cw_1/${sample}.fq     # link-name to appear in your directory 

    ln -s $raw_file $link_name             # instruction to make a soft link 
    test_file=/export/biostuds/2266643a/BIOL5177_rnaseq/biol5177_work/cw_1/${sample}.25K.fq       # test fast file containing 25K reads 
