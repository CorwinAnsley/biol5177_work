...
#PBS -N process_data
#PBS -d /export/biostuds/2266643a/BIOL5177_rnaseq/Practicals/practical_2/nondiscovery 
#PBS -m abe 
...
hs2index="./Hisat2Index/dm3"         # path to reference genome hisat2 indexes 
gtf=dmel-all-no-analysis-r5.57clean2.gtf    	         # path to GTF file 
...
for sample in tb1 tb2 tb3 wf1 wf2 wf3
...
do
    ...
    scythe -o $trim1 -a illumina_adapter.fa -q illumina ${fastq}
    sickle se -f $trim1 -t illumina -o $trim2  -q 10 -l 51
    hisat2 -p 4 --phred64 -x ${hs2index} -U ${trim2} -S ${sam} # command to execute hisat2 
